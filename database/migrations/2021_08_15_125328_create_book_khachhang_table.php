...
class CreateBookKhachhangTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('book_khachhang', function (Blueprint $table) {
            $table->engine = 'InnoDB';
        ...
        DB::statement("ALTER TABLE `book_khachhang` comment 'Khách hàng # Khách hàng'");
    }
    ...
    {
        Schema::dropIfExists('book_khachhang');
    }
}
