...
class CreateBookLoaiTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('book_loai', function (Blueprint $table) {
            $table->engine = 'InnoDB';
        ...
        DB::statement("ALTER TABLE `book_loai` comment 'Loại sản phẩm # Loại sản phẩm'");
    }
