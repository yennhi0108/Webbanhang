...
class KhachhangTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        array_push($list, [
            ...
            'kh_hoTen'     => 'Trần Thị Yến Nhi',
            'kh_gioiTinh'  => $gender == VnBase::VnMale,
            'kh_email'     => 'Nhib1710117@student.ctu.edu.vn',
            'kh_ngaySinh'  => '1999-08-01',
            'kh_diaChi'    => '11H2/1,KV3, Quận Ninh Kiều, TP Cần Thơ',
            'kh_dienThoai' => '0961099815',
            'kh_taoMoi'    => $today->format('Y-m-d H:i:s'),
            'kh_capNhat'   => $today->format('Y-m-d H:i:s'),
            'kh_trangThai' => 2 // Khả dụng
        ]);
        DB::table('book_khachhang')->insert($list);
    }
}
